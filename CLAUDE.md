...
10. ~~**Inferno IFR Token integration**~~ -- DONE. Commits `9c1b83a`, `06aa37b`, `d4b6fb3`, `d89cbb9`. Server uses ethers.js `balanceOf()` on IFR token `0x77e99917Eca8539c62F509ED1193ac36580A6e7B`. 1,000 IFR = Pro, 5,000 IFR = Premium. Manual wallet: 30-day expiration, one device. WalletConnect (future): lifetime, unlimited devices. Verified on S4: 400.6M IFR → PREMIUM. Settings shows expiration countdown.
