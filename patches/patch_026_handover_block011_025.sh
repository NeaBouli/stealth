...
echo "== patch_026: add handover report for patches 011-025 =="

mkdir -p docs/dev

cat <<'DOC' > docs/dev/HANDOVER_MAINDEV2_BLOCK011_025.md
...
echo "[OK] Created docs/dev/HANDOVER_MAINDEV2_BLOCK011_025.md"
echo "== patch_026 done =="
