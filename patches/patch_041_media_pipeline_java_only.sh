...
echo "== patch_041: switch ghostnet media pipeline to pure Java implementation =="

# 1) Remove Kotlin versions (we use Java-only for compatibility)
if [ -f client_android/app/src/main/java/com/securecall/app/ghostnet/media/AudioPlaybackStub.kt ]; then
  rm client_android/app/src/main/java/com/securecall/app/ghostnet/media/AudioPlaybackStub.kt
  echo "[OK] Removed AudioPlaybackStub.kt"
fi

if [ -f client_android/app/src/main/java/com/securecall/app/ghostnet/media/MediaRouterInboundStub.kt ]; then
  rm client_android/app/src/main/java/com/securecall/app/ghostnet/media/MediaRouterInboundStub.kt
  echo "[OK] Removed MediaRouterInboundStub.kt"
fi

# 2) Write AudioPlaybackStub.java
cat <<'JAVA' > client_android/app/src/main/java/com/securecall/app/ghostnet/media/AudioPlaybackStub.java
...
echo "[OK] Wrote AudioPlaybackStub.java"

# 3) Write MediaRouterInboundStub.java
cat <<'JAVA' > client_android/app/src/main/java/com/securecall/app/ghostnet/media/MediaRouterInboundStub.java
package com.securecall.app.ghostnet.media;
...
echo "[OK] Wrote MediaRouterInboundStub.java"
