...
object FrameHeaderUtils {
    ...
    // CRYPTO-39: Mapping FrameType → Flags
    ...
    // CRYPTO-39: generischer FrameV1-Encrypt
    fun encryptFrameV1ForType(
        ...
        return com.securecall.app.ghostnet.crypto.binding.SessionCipherBinding.encryptFrameV1(ctx, body, flags)
    }
}
